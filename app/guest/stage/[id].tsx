...
export default function ProfileScreen() {
  ...
  const currentIndex = setSchedule.findIndex((slot, i) => {
    ...
    const end =
      i < setSchedule.length - 1 ? toMinutes(setSchedule[i + 1].time) : 24 * 60;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <ThemedView>
          <ThemedText type="title" style={styles.title}>Scène Electro House</ThemedText>
        </ThemedView>

        <ThemedText style={styles.description}>Plonge au cœur d’un tourbillon de basses percutantes et de drops survoltés ! La scène Electro House du festival fait vibrer les foules avec des sets explosifs, des lumières stroboscopiques et une énergie sans relâche.
          Prépare-toi à danser, sauter, et te perdre dans le rythme effréné de l’électro.</ThemedText>
