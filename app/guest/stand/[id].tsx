...
const menu: MenuItem[] = [
  ...
  },
  {
    ...
    price: "4 €",
    image:
      "https://www.lespommesdeterre.com/wp-content/uploads/2017/10/frites-maison-c-shutterstock_bd.jpg",
  },
  {
    id: "3",
    name: "Frites fraîches",
...
export default function ProfileScreen() {
  ...
  return (
    <ParallaxScrollView
      ...
      headerTitle={"Choudidou"}
    >
      <ThemedText style={styles.description}>
        Grillades qui crépitent, effluves de cheddar fondant. On sert des
        burgers généreux – pain brioché doré, steak à point ou galette veggie –
        accompagnés de frites croustillantes coupées maison et d'un bar à sauces
        gourmandes.
      </ThemedText>
