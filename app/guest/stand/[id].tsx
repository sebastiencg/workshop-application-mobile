  ...
  return (
    ...
    >
      ...
      <ThemedText style={styles.description}>
        Grillades qui crépitent, effluves de cheddar fondant. On sert des burgers généreux – pain
        brioché doré, steak à point ou galette veggie – accompagnés de frites croustillantes coupées
        maison et d'un bar à sauces gourmandes.
      </ThemedText>
