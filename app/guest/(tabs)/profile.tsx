...
export default function ProfileScreen() {
  ...
  const expenses = [
    ...
    { id: "3", place: "Saucisse Bar", amount: 25, time: "13:05" },
    { id: "4", place: "Saucisse Bar", amount: 25, time: "13:05" },
    { id: "5", place: "Saucisse Bar", amount: 25, time: "13:05" },
  ...
  return (
    <View style={styles.flex}>
                  ...
                  >
                    <View style={styles.cardContent}>
                      <Text style={styles.cardTitle}>
                        {pack.text ? "" : pack.amount}{" "}
                      </Text>
                      <Text style={styles.coinsLabel}>
                        {pack.text ? pack.text : "coins"}
                      </Text>
                      {pack.bonus > 0 && (
      ...
      <Modal
        ...
        onRequestClose={() => setCustomModalVisible(true)}
      >
        <Pressable
          style={styles.modalBackdrop}
